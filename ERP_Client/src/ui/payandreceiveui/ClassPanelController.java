...
import ui.mainui.ClassManager.ClassRecordSet;
import ui.mainui.StudentManager.StudentRecordSet;
import ui.mainui.TakeCourseManager.TakeCourseRecordSet;
...
public class ClassPanelController implements Initializable {
    ...
    private void CalculateFired(ActionEvent e) {
        ...
        new BackgroundRunner() {
            ...
            @Override
            public void background() throws Exception {
                StudentRecordSet rs = CustomerManager.getStudentsByClassID(classid);
                while (rs.next()) {
                    total_num++;
                    long sid = rs.getID();
